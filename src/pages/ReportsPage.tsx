      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm transition-colors">
               <div className="flex items-center gap-3 mb-2">
                 ...
                 <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Ingresos</span>
               </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm transition-colors">
               <div className="flex items-center gap-3 mb-2">
                 ...
                 <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Gastos</span>
               </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm transition-colors">
               <div className="flex items-center gap-3 mb-2">
                 <div className="p-2 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-lg"><DollarSign size={20} /></div>
                 <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Balance</span>
               </div>
               <p className={`text-2xl font-bold ${stats.balance >= 0 ? 'text-gray-900 dark:text-white' : 'text-red-600 dark:text-red-400'}`}>
          ...
          <div className="lg:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm transition-colors">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Gastos por Categoría</h3>
                  ...
                  <div key={cat.name}>
                    <div className="flex justify-between items-center text-sm mb-1">
                       ...
                       <div className="text-right">
                         <span className="text-gray-900 dark:text-white font-bold block">{formatCurrency(cat.amount)}</span>
                       </div>
                    </div>
                    ...
                    <p className="text-xs text-gray-400 dark:text-gray-500 text-right mt-1">{Math.round(percentage)}% del total</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm transition-colors">
             <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Resumen</h3>
             ...
             <div className="flex flex-col items-center justify-center py-8">
               <div className="relative w-40 h-40">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-3xl font-bold text-gray-900 dark:text-white">{Math.round(stats.savingsRate)}%</span>
                    <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest">Ahorro</span>
                  </div>
               </div>
               <p className="text-center text-gray-500 dark:text-gray-400 text-sm mt-4 px-4">
